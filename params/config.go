...
var (
	MainnetGenesisHash = common.HexToHash("0x0e5a76a1d520169a6d267d8f19557a9f3ccb34a7d09b2035223e1ac2ec1677f3") // Mainnet genesis hash to enforce below configs on
...
var (
	...
	MainnetChainConfig = &ChainConfig{
		...
		HomesteadBlock: big.NewInt(4127),
		DAOForkBlock:   nil,
		DAOForkSupport: true,
		EIP150Block:    big.NewInt(0),
		EIP150Hash:     common.HexToHash("0x0e5a76a1d520169a6d267d8f19557a9f3ccb34a7d09b2035223e1ac2ec1677f3"),
...
type ChainConfig struct {
	...
	EIP998Block *big.Int `json:"eip998Block,omitempty"` // EIP158 HF block
...
func (c *ChainConfig) String() string {
	...
	return fmt.Sprintf("{ChainID: %v Homestead: %v DAO: %v DAOSupport: %v EIP150: %v EIP155: %v EIP158: %v EIP998: %v Byzantium: %v Engine: %v}",
		c.ChainId,
		c.HomesteadBlock,
		c.DAOForkBlock,
		c.DAOForkSupport,
