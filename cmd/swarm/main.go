...
import (
	...
	"github.com/etherbanking/go-etherbanking/swarm"
	bzzapi "github.com/etherbanking/go-etherbanking/swarm/api"
...
var (
	...
	EnsAPIFlag = cli.StringFlag{
		...
		Value: node.DefaultIPCEndpoint("gebc"),
	}
...
// This init function sets defaults so cmd/swarm can run alongside gebc.
func init() {
