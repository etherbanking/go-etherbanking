...
import (
	...
	"github.com/etherbanking/go-etherbanking/internal/jsre"
	"github.com/etherbanking/go-etherbanking/internal/web3ext"
...
// Welcome show summary of current Gebc instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	// Print some generic Gebc metadata
	fmt.Fprintf(c.printer, "Welcome to the Gebc JavaScript console!\n\n")
	c.jsre.Run(`
