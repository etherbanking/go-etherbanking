...
# 1. install gebc for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gebc
# 5. create gebc, attach and uninstall start menu entries
...
!define GROUPNAME "Etherbanking"
!define APPNAME "Gebc"
!define DESCRIPTION "Official Go implementation of the Etherbanking protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gebc is installed global
