Name "gebc ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/etherbanking/go-etherbanking/issues"
!define UPDATEURL "https://github.com/etherbanking/go-etherbanking/releases"
!define ABOUTURL "https://github.com/etherbanking/go-etherbanking#ethereum-go"
...
# Install gebc binary
Section "Gebc" GETH_IDX
  SetOutPath $INSTDIR
  file {{.Gebc}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gebc.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gebc.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Gebc incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gebc outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gebc UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Gebc incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\gebc.exe" "" "" "Ethereum" 30303 "" "" ""
  SimpleFC::AdvAddRule "Gebc outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\gebc.exe" "" "" "Ethereum" "" 30303 "" ""
  SimpleFC::AdvAddRule "Gebc UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\gebc.exe" "" "" "Ethereum" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/ethereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "R" "HKLM" "\\.\pipe\gebc.ipc"
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "A" "HKLM" "\\.\pipe\gebc.ipc"
