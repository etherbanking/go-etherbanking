...
// NodeConfig represents the collection of configuration values to fine tune the Gebc
...
// Node represents a Gebc Ethereum node instance.
type Node struct {
	node *node.Node
}

// NewNode creates and configures a new Gebc node.
