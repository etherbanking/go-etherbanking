...
import (
	...
	"github.com/etherbanking/go-etherbanking/accounts"
	"github.com/etherbanking/go-etherbanking/common"
	"github.com/etherbanking/go-etherbanking/common/hexutil"
	"github.com/etherbanking/go-etherbanking/consensus"
	"github.com/etherbanking/go-etherbanking/consensus/clique"
	"github.com/etherbanking/go-etherbanking/consensus/ethash"
	"github.com/etherbanking/go-etherbanking/core"
	"github.com/etherbanking/go-etherbanking/core/bloombits"
	"github.com/etherbanking/go-etherbanking/core/types"
	"github.com/etherbanking/go-etherbanking/core/vm"
	"github.com/etherbanking/go-etherbanking/eth/downloader"
	"github.com/etherbanking/go-etherbanking/eth/filters"
	"github.com/etherbanking/go-etherbanking/eth/gasprice"
	"github.com/etherbanking/go-etherbanking/ethdb"
	"github.com/etherbanking/go-etherbanking/event"
	"github.com/etherbanking/go-etherbanking/internal/ethapi"
	"github.com/etherbanking/go-etherbanking/log"
	"github.com/etherbanking/go-etherbanking/miner"
...
func New(ctx *node.ServiceContext, config *Config) (*Ethereum, error) {
	...
	log.Info("Initialising Etherbanking protocol", "versions", ProtocolVersions, "network", config.NetworkId)

	if !config.SkipBcVersionCheck {
		bcVersion := core.GetBlockChainVersion(chainDb)
		if bcVersion != core.BlockChainVersion && bcVersion != 0 {
			return nil, fmt.Errorf("Blockchain DB version mismatch (%d / %d). Run gebc upgradedb.\n", bcVersion, core.BlockChainVersion)
		}
